...
- The ORRO product line is published on PyPI through 0.2.4, while this repository
  packages the 0.2.16 release candidate. The post-release target state is: `orro`
  0.2.16 is published on PyPI. It becomes true only after `v0.2.16` is tagged and
...
development dogfood can run the 0.2.16 source directly against pinned Depone and
witnessd checkouts.
