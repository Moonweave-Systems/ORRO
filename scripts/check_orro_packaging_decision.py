...
def check_plan() -> None:
    ...
    if plan.get("source_version") != "0.2.16":
        fail("wrapper package plan source_version must be 0.2.16")
...
def check_docs() -> None:
    ...
    require_contains("packaging decision doc", text, "`orro` 0.2.16 is published on PyPI")
