...
def check_plan() -> None:
    ...
    if plan.get("source_version") != "0.2.19":
        fail("wrapper package plan source_version must be 0.2.19")
...
def check_docs() -> None:
    ...
    require_contains("packaging decision doc", text, "`orro` 0.2.19 is published on PyPI")
