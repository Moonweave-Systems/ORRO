...
def check_plan() -> None:
    ...
    if plan.get("source_version") != "0.2.18":
        fail("wrapper package plan source_version must be 0.2.18")
...
def check_docs() -> None:
    ...
    require_contains("packaging decision doc", text, "`orro` 0.2.18 is published on PyPI")
