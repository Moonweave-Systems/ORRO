...
def check_plan() -> None:
    ...
    if plan.get("source_version") != "0.2.1":
        fail("wrapper package plan source_version must be 0.2.1")
...
def check_docs() -> None:
    ...
    require_contains("packaging decision doc", text, "`orro` 0.2.1 is published on PyPI")
