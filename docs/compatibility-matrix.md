...
| --- | --- | --- | --- | --- | --- |
| depone-n-witnessd-n | n/a | `ef0c32c0149a256f24a8a739793b9c4f2541851a` | `1932f00802f817822d49c70616e963d11227d7fb` | pass | Current locally validated engine pair; witnessd v2.6.0. |
...
| orro-rc-locked-triplet | `63d8887815bb9a17ed0202949342a70993a5abc9` | `ef0c32c0149a256f24a8a739793b9c4f2541851a` | `1932f00802f817822d49c70616e963d11227d7fb` | pass | Matches witnessd v2.6.0, `engine-lock/orro-e2e-engine-lock.json`, `release/orro-release-manifest.v0.json`, and `release/compatibility-matrix.v0.json`. |

The locked witnessd revision is release `v2.6.0` (source version 2.6.0). It
satisfies the ORRO 0.2.8 package requirement `witnessd>=2.4.0,<3.0.0`.
