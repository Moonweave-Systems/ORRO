...
| --- | --- | --- | --- | --- | --- |
| depone-n-witnessd-n | n/a | `b27cc9b0a1e55cc667d19b8bfc89ef484aa60c97` | `1932f00802f817822d49c70616e963d11227d7fb` | pass | Current locally validated engine pair; witnessd v2.8.0. |
...
| orro-rc-locked-triplet | `9e7cc262c5cb9125e4fbf2a4fc92a4c66e3d1638` | `b27cc9b0a1e55cc667d19b8bfc89ef484aa60c97` | `1932f00802f817822d49c70616e963d11227d7fb` | pass | Matches witnessd v2.8.0, `engine-lock/orro-e2e-engine-lock.json`, `release/orro-release-manifest.v0.json`, and `release/compatibility-matrix.v0.json`. |

The locked witnessd revision is release `v2.8.0` (source version 2.8.0). It
satisfies the ORRO 0.2.10 package requirement `witnessd>=2.4.0,<3.0.0`.
