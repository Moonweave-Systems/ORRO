...
| --- | --- | --- | --- | --- | --- |
| depone-n-witnessd-n | n/a | `641f0b03eb8b26ab53168045cba4d70f17c15b57` | `5f7ccc35174f92ec1d7565c3066cd903e605442d` | pass | Current locally validated engine pair; witnessd v2.13.0. |
...
| orro-rc-locked-triplet | `1927a9b8351276b7bb62313fc6a52b065527b42a` | `641f0b03eb8b26ab53168045cba4d70f17c15b57` | `5f7ccc35174f92ec1d7565c3066cd903e605442d` | pass | Matches witnessd v2.13.0, `engine-lock/orro-e2e-engine-lock.json`, `release/orro-release-manifest.v0.json`, and `release/compatibility-matrix.v0.json`. |

The locked witnessd revision is release `v2.13.0` (source version 2.13.0). It
