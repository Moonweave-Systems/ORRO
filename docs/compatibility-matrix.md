...
| --- | --- | --- | --- | --- | --- |
| depone-n-witnessd-n | n/a | `79752ab7f00fab9b81d65f802201012739bb04d6` | `6123fc50c1f3c2d27b057b06fb2c71574ea80ffa` | pass | Current locally validated engine pair; witnessd v2.4.2. |
...
| orro-rc-locked-triplet | `842bda38a3358b668b8a8a8f5b6ca57c4acc9c1a` | `79752ab7f00fab9b81d65f802201012739bb04d6` | `6123fc50c1f3c2d27b057b06fb2c71574ea80ffa` | pass | Matches witnessd v2.4.2, `engine-lock/orro-e2e-engine-lock.json`, `release/orro-release-manifest.v0.json`, and `release/compatibility-matrix.v0.json`. |

The locked witnessd revision is release `v2.4.2` (source version 2.4.2). It
satisfies the ORRO 0.2.2 package requirement `witnessd>=2.4.0,<3.0.0`.
