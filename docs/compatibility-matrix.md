...
| --- | --- | --- | --- | --- | --- |
| depone-n-witnessd-n | n/a | `71df55373c6e82d0ff30bc6452c8349ed49ebda8` | `1100de4b9f9c64be81ffa36535a778baf3751c0d` | pass | Current locally validated engine pair; witnessd v2.5.1. |
...
| orro-rc-locked-triplet | `bea1fbd9aa94eb0efb35806fb2e50964a5773486` | `71df55373c6e82d0ff30bc6452c8349ed49ebda8` | `1100de4b9f9c64be81ffa36535a778baf3751c0d` | pass | Matches witnessd v2.5.1, `engine-lock/orro-e2e-engine-lock.json`, `release/orro-release-manifest.v0.json`, and `release/compatibility-matrix.v0.json`. |

The locked witnessd revision is release `v2.5.1` (source version 2.5.1). It
satisfies the ORRO 0.2.6 package requirement `witnessd>=2.4.0,<3.0.0`.
