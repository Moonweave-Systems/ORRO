...
| --- | --- | --- | --- | --- | --- |
| depone-n-witnessd-n | n/a | `c960b95f406689b468e25c29e2b5164921aa8886` | `9580464a4e03999ddf9eec00e0da278ec325c727` | pass | Current locally validated engine pair; witnessd v2.11.3. |
...
| orro-rc-locked-triplet | `5a6e799dffe0b3c37223c4078f304b374e2b2fe1` | `c960b95f406689b468e25c29e2b5164921aa8886` | `9580464a4e03999ddf9eec00e0da278ec325c727` | pass | Matches witnessd v2.11.3, `engine-lock/orro-e2e-engine-lock.json`, `release/orro-release-manifest.v0.json`, and `release/compatibility-matrix.v0.json`. |

The locked witnessd revision is release `v2.11.3` (source version 2.11.3). It
satisfies the ORRO 0.2.17 package requirement `witnessd>=2.4.0,<3.0.0`.
