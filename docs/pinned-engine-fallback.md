...
the canonical 0.2.7 source, whose metadata declares `witnessd>=2.4.0,<3.0.0`. The current
engine lock pins witnessd 2.5.2 at tag `v2.5.2`, satisfying that dependency.
