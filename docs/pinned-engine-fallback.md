...
the canonical 0.2.1 source, whose metadata declares `witnessd>=2.4.0,<3.0.0`. The current
engine lock pins witnessd 2.4.1 at tag `v2.4.1`, satisfying that dependency.
