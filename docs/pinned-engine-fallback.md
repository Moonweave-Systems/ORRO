...
the canonical 0.2.21 source, whose metadata declares `witnessd>=2.4.0,<3.0.0`. The current
engine lock pins witnessd 2.11.7 at tag `v2.11.7`, satisfying that dependency.
