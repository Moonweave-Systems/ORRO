...
the canonical 0.2.18 source, whose metadata declares `witnessd>=2.4.0,<3.0.0`. The current
engine lock pins witnessd 2.11.4 at tag `v2.11.4`, satisfying that dependency.
